...
\subsection{O demonstrador e a técnica de demonstração}
...
\item \textit{Shadowing}: o robô não executa a ação, ele apenas grava a demonstração de um agente externo. Posteriormente, ele tenta a repetição dos passos, numa tentativa de imitar os movimentos previamente executados.
\end{itemize}
