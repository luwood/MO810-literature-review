...
\subsection{Técnicas para derivação da Política}
Após o passo de coletar exemplos é necessário derivar uma política, realizando assim o aprendizado. As três principais técnicas para realizar essa tarefa estão descritas a seguir e sumarizadas na figura
\begin{itemize}
\item Mapeamento de funções: os dados de demonstração são usados para mapear diretamente um par estado-ação.  
\item Modelo sistemático: os dados de demonstração são utilizados para determinar um modelo de dinâmicas e possivelmente uma função de recompensa. 
